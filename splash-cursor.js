function initSplashCursor(containerId) {
    ...
    let config = {
        ...
        PAUSED: false,
        BACK_COLOR: { r: 0.937, g: 0.905, b: 0.847 },
        TRANSPARENT: true
    };
    ...
    const brandHexes = ['#204937', '#dcb558', '#efe7d8'];
    ...
    function generateColor() {
        const randomHex = brandHexes[Math.floor(Math.random() * brandHexes.length)];
    ...
    function hexToRGB(hex) {
        ...
        // The original React Bits scales color heavily, we multiply by 0.15 for fluid blending
